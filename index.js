...
var start, isBlink, isLight, isRun, isShow, isWarned, handler, latency, stopBy, delay, totalDuration, audioRemind, audioEnd, pad, formatTime, newAudio, soundToggle, show, adjust, toggle, reset, blink, count, run, resize, updateBattery;
start = null;
isBlink = false;
isLight = true;
isRun = false;
...
updateBattery = function(remaining){
  var percent, bar, empty;
  percent = totalDuration ? Math.max(0, Math.min(remaining / totalDuration, 1)) : 0;
  bar = $('#battery-level');
  empty = $('#battery-empty');
